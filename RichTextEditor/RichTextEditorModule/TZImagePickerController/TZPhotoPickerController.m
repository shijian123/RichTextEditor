...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.showGifTag = tzImagePickerVc.showGifTag;
    cell.model = model;
    ...
    cell.didSelectPhotoBlock = ^(BOOL isSelected) {
        ...
        if (isSelected) {
            ...
            if (tzImagePickerVc.selectedModels.count < tzImagePickerVc.maxImagesCount) {
                ...
                [YXImagePickerTool yx_getImageData:model.asset completeHandler:^(BOOL isGifImage, BOOL overMaxLimit) {
                    __strong typeof(weakSelf) strongSelf = weakSelf;
                    if (overMaxLimit) {
                        
//                        YXBaseAlertView *alertView = [[NSBundle mainBundle] loadNibNamed:@"YXBaseAlertView" owner:nil options:nil].firstObject;
//                        [alertView setStyleWithStyle:2];
//                        alertView.contentLab.text = @"gif过大，无法发布";
//                        [alertView.sureBtn setTitle:@"我知道了" forState:UIControlStateNormal];
//                        
//                        [alertView show];
                    ...
                    [strongCell refreshSelectImageViewStatus:strongCell.selectPhotoButton.selected];
                ...
                if (self.showMaxTitle.length > 0) {
                    [tzImagePickerVc showAlertWithTitle:self.showMaxTitle];
                }else {
